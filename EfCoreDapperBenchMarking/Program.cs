            ...
            do
            {
                ...
                switch (input)
                {
                    ...
                    case 'T':
                        ...
                        NumRuns = 3; //int.Parse(Console.ReadLine());

                        //Gather Details for Test
                        Console.WriteLine("# of Sports per Run: ");
                        NumSports = 20; //int.Parse(Console.ReadLine());

                        Console.WriteLine("# of Teams per Sport: ");
                        NumTeams = 100; //int.Parse(Console.ReadLine());

                        Console.WriteLine("# of Players per Team: ");
                        NumPlayers = 100; //int.Parse(Console.ReadLine());
...
/*                        foreach (var sport in sports)
        ...
        public static List<TestResult> RunTests(int runID, Framework framework, ITestSignature testSignature)
        {
            ...
            {
                playersForTeamResults.Add(testSignature.GetTeamByID(i));
            }
            ...
            {
                teamsForSportResults.Add(testSignature.GetTeamForSportByIdAsync(i));
            }
